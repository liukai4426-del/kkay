...
src = pee4.src
DAYS = 720
OUT = Path("backtest_output_v170_4h_ema_score_short_drift020_720d")
LOCK_MS = 60 * 60_000
VERSION = "1.7.0"
BUILD = "1700"
...
def main():
    ...
    payload["research"] = "KAYTRADE V1.7.0 Build1700 A/B: 4H explicit opposite blocked; aligned+1 and EMA-score allowed; SHORT Entry Drift >0.20 ATR5 blocked, 720D, 2000U"
    ...
    new = OUT / "result_v170_4h_ema_score_short_drift020_720d.json"
    ...
    for oldcsv in (
        ...
        if oldcsv.exists():
            oldcsv.rename(OUT / "trades_v170_4h_ema_score_short_drift020_720d.csv")
            break

    readme = OUT / "README.txt"
    readme.write_text(
        "KAYTRADE V1.7.0 Build1700 720D A/B backtest.\n"
    ...
    print("V170_4H_EMA_SCORE_SHORT_DRIFT020_720D_RESULT", json.dumps(payload, ensure_ascii=False, indent=2), flush=True)
