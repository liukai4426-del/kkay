...
All hard gates and risk controls otherwise remain V1.5.2-equivalent. The ATR
research patch also makes all R-based checks use the same 15m ATR stop distance.
"""
...
def _metrics_atr15(*args, **kwargs):
    ...
    m['entry_threshold'] = 5.0
    m['stop_atr_timeframe'] = '15m'
    m['stop_atr_multiplier'] = 1.5
    m['target_atr_multiplier'] = 3.0
    m['reward_r'] = 2.0
    m['research_variant'] = 'V1.5.2 / score>=5.0 / 15m ATR 1.5x SL / 3.0x ATR TP / cost<=0.30R'
    return m
