...
# V1.6.6 Build1661 keeps the V1.6.5 strategy/order-write semantics and adds
# transient read-only GET resilience: read failures skip the current cycle but
# do not globally stop auto trading; ambiguous writes remain fail-closed.
...
bundle = BUNDLE(collection, name='KAYTRADE.app',icon=str(root / 'OKXLocal.icns'),
                ...
                info_plist={'CFBundleShortVersionString': '1.6.6',
                            'CFBundleVersion': '1661',
