...
# V1.6.8 Build1680 keeps the audited write/idempotency protections, Algo read-side
# synchronization, strict 15m-only BOLL source, and adds the finalized 15m lifecycle
# plus 4H/1H-EMA scoring semantics.
...
bundle = BUNDLE(collection, name='KAYTRADE.app',icon=str(root / 'OKXLocal.icns'),
                ...
                info_plist={'CFBundleShortVersionString': '1.6.8',
                            'CFBundleVersion': '1680',
