...
# V1.6.8 Build1681 keeps the audited Build1680 strategy/write protections and
# adds only final runtime/log cleanup plus clearer Algo synchronization wording.
