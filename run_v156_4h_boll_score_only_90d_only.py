#!/usr/bin/env python3
"""Experiment-only 90D runner for V1.5.6 4H BOLL score-only variant."""
...
OUTDIR = Path("backtest_output_v156_4h_boll_score_only_90d_only")
...
def main():
    ...
    metrics.update({
        "label": "V1.5.6 + 4H BOLL auxiliary +1 only; 15m pullback +1",
        "days": 90,
    ...
    print("V156_4H_BOLL_SCORE_ONLY_90D_EXPERIMENT")
