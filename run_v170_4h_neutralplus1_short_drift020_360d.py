...
def main():
    ...
    payload["research"] = "KAYTRADE V1.7.0 Build1700 A/B: 4H explicit opposite blocked; aligned+1 and neutral+1 allowed; SHORT Entry Drift >0.20 ATR5 blocked, 360D, 2000U"
    ...
    new = OUT / "result_v170_4h_neutralplus1_short_drift020_360d.json"
    ...
    for oldcsv in (
        ...
        if oldcsv.exists():
            oldcsv.rename(OUT / "trades_v170_4h_neutralplus1_short_drift020_360d.csv")
            break
    ...
    print("V170_4H_NEUTRALPLUS1_SHORT_DRIFT020_360D_RESULT", json.dumps(payload, ensure_ascii=False, indent=2), flush=True)
