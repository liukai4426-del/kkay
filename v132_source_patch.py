...
replace('desktop.py', "    Path(sys.argv[2]).write_text('PASS: KAYTRADE V1.3.1 UI, direction-aware score colors, rounded dark controls, animated borderless score bars, red/green P&L, demo default, settings and bundled CA roots. Screenshots use synthetic test data. No network or orders.\\n')\n", "    Path(sys.argv[2]).write_text('PASS: KAYTRADE V1.3.2 UI, 10-point detailed scoring, direction-aware score colors, rounded dark controls, animated borderless score bars, red/green P&L, demo default, settings and bundled CA roots. Screenshots use synthetic test data. No network or orders.\\n')\n")
